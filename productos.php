...
?>
    ...
    <a href="existenciapdf.php" class="btn btn-danger" >Imprimir existencia</a>
			...
			$db = $database->open();
			try{	
				$sql = 'SELECT codigo,products.id,nombre,name,cantidad,fecha,precio,detalles FROM products INNER JOIN depa on depa.id = products.iddepa';
				foreach ($db->query($sql) as $row) {
					?>
                                                <tr> 
                                                    <td><?php echo $row['id']; ?> </td>
                                                    <td><span class="name"><?php echo $row['codigo']; ?></span></td> 
						...
						<?php include('BorrarEditarModalproductos.php'); ?>
                                                </tr>
                                                <?php 
				}
			}
