...
<body>
        ...
        <div class="content">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <h4 class="box-title">Productos vendidos</h4>
			...
			$db = $database->open();
			try{	
				$sql = 'SELECT sold.id,sold.cantidad,products.name,sold.fecha,sold.precio,products.detalles FROM sold
                        inner join products on products.id = sold.idpro  ';
				foreach ($db->query($sql) as $row) {
					?>
                                                <tr> 
                                                    ...
                                                    <td><span class="name"><?php echo '$'.$row['precio']*$row['cantidad'] ?></span></td> 
						...
						<?php include('BorrarEditarModalvendidos.php'); ?>
                                                </tr>
                                                <?php 
				}
			}
...
<?php include('AgregarModalvendidos.php'); ?> 
</body>
</html>