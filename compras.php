...
<body>
        ...
        <div class="content">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <h4 class="box-title">Entradas de productos, Compras</h4>
                                      </div>
                                <div class="card-body--">
			...
			$db = $database->open();
			try{	
				$sql = 'SELECT compras.id,compras.cantidad,name,compras.fecha,compras.precio,products.detalles FROM compras 
                                inner join products on products.id = compras.idpro ';
				foreach ($db->query($sql) as $row) {
					?>
                     ...
                     <?php if($_SESSION['user']==1){?>     
						...
						<?php include('BorrarEditarModalcompras.php'); ?>
                                                </tr>
                                                <?php 
				}
			}
