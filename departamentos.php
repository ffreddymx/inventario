                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Departamentos</h4>

<a href="#addnew" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Agregar un departamento</a>
                                </div>
                                <div class="card-body--">
			...
			$db = $database->open();
			try{	
				$sql = 'SELECT * FROM depa order by nombre ';
				foreach ($db->query($sql) as $row) {
					?>
						...
						<?php include('BorrarEditarModaldepa.php'); ?>
                                                </tr>
                                                <?php 
				}
			}
...
<?php include('AgregarModaldepa.php'); ?> 
</body>
</html>