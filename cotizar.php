                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body bg-warning">
                                    <h4 class="box-title">Realiza tu contización</h4>
...
<button type="submit" class="btn btn-danger" data-dismiss="modal"> Buscar</button>
         ...
         if(!empty($_POST['codigo']))
			...
			$db = $database->open();
			//try{	
$sql = "SELECT products.id,codigo,nombre,name,cantidad,fecha,precio,detalles  FROM products INNER JOIN depa on depa.id = products.iddepa WHERE products.codigo LIKE '%$cod%' or '$cod' = ''";
				foreach ($db->query($sql) as $row) {
					?>
                                                <tr> 
                                                    ...
                                                    <td>
							<a href="#cotizar_<?php echo $row['id']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> Agregar</a>
						</td> 
                                                </tr>
                                                <tr class=" pb-0">
